...
class DistributedHelper(object):
    ...
    def init_ddp_backend(self):
        ...
        dist.init_process_group(backend="nccl", init_method=self.init_method, rank=env_dict['WORLD_RANK'], world_size=env_dict['WORLD_SIZE'], timeout=timedelta(seconds=1800))
